...
function CategorySelectModal(props) {
    ...
    const renderSwitchBrands = (category) => {
        switch(category){
            case 'smartphones':
                return (<div className='choosebrandcontainer slide'>
                    ...
                    <section>
                        ...
                        <div className='otheroptionbrand' onClick={(e)=>{ props.chooseBrand(e) }}>Other</div>
                    </section>
                </div>);
                break;
            case 'laptops':
            ...
            case 'cellphones':
                ...
                case 'printers':
                    ...
                    <h1>Printer Type:</h1>
                    <section>
                        <div value='Inkjet' className='otheroptionbrand'>Inkjet</div>
                        <div value='Laser' className='otheroptionbrand'>Laser</div>
                    </section>
                </div>);
                break;
                case 'iotdevices':
